    ...
    <section class="infoPanel" :class="{ 'show': movePanel }">
      ...
      <div v-if="infoPanel" class="infoPanel__info">
        ...
        <p class="infoPanel__btns">
          <a class="btnDefault" v-if="infoPanel.demo" :href="infoPanel.demo" target="_blank" rel="noopener noreferrer">
            <i class="icon">
          ...
          <a class="btnDefault" v-if="infoPanel.github" :href="infoPanel.github" target="_blank" rel="noopener noreferrer">
            <i class="icon">
